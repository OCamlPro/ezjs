...
class type options = object
  ...
  (* method step : (int -> tween -> unit) callback prop *)
  method progress : (promise t -> int -> int -> unit) callback prop
  method complete : (unit -> unit) callback prop
  method start : (promise t -> unit) callback prop
  method _done : (promise t -> bool t -> unit) callback prop
  method fail : (promise t -> bool t -> unit) callback prop
  method always : (promise t -> bool t -> unit) callback prop
end
...
let current_target0 (e:event_jq t) = e##currentTarget
let current_target (e:event_jq t) = Of_dom.of_element e##currentTarget
let event_data (e:event_jq t) = e##data
let delegate_target0 (e:event_jq t) = e##delegateTarget
let delegate_target (e:event_jq t) = Of_dom.of_element e##delegateTarget
...
let related_target0 (e:event_jq t) = e##relatedTarget
let related_target (e:event_jq t) = Of_dom.of_element e##relatedTarget
...
let event_target0 (e:event_jq t) = e##target
let event_target (e:event_jq t) = Of_dom.of_element e##target
...
class type deferred = object
  method always : (unit -> unit) callback -> (unit -> unit) callback opt -> deferred t meth
  method catch : (unit -> unit) callback -> promise t meth
  method _done : (unit -> unit) callback -> (unit -> unit) callback opt -> deferred t meth
  method fail : (unit -> unit) callback -> (unit -> unit) callback opt -> deferred t meth
  ...
  method pipe : (unit -> unit) callback opt -> (unit -> unit) callback opt -> promise t meth
  method pipe_prg : (unit -> unit) callback opt -> (unit -> unit) callback opt
    -> (unit -> unit) callback opt -> promise t meth
  method progress : (unit -> unit) callback -> (unit -> unit) callback opt -> deferred t meth
  ...
  method _then : (unit -> unit) callback -> (unit -> unit) callback opt
    -> (unit -> unit) callback opt -> promise t meth
end
...
class type jquery = object
  ...
  method ajaxComplete : (event_jq t -> XmlHttpRequest.xmlHttpRequest t -> json t -> unit)
      callback -> jquery t meth
  method ajaxError : (event_jq t -> XmlHttpRequest.xmlHttpRequest t -> json t ->
                      js_string t -> unit) callback -> jquery t meth
  method ajaxSend : (event_jq t -> XmlHttpRequest.xmlHttpRequest t -> json t -> unit)
      callback -> jquery t meth
  method ajaxStart : (unit -> unit) callback -> jquery t meth
  method ajaxStop : (unit -> unit) callback -> jquery t meth
  method ajaxSuccess : (event_jq t -> XmlHttpRequest.xmlHttpRequest t ->
                        json -> json -> unit) callback -> jquery t meth
  ...
  method bind_fun : js_string t -> 'a t opt -> (event_jq t -> unit) callback -> jquery t meth
  method bind_b : js_string t -> 'a t opt -> bool opt -> jquery t meth
  method blur_fun : (event_jq t -> unit) callback -> jquery t meth
  method blur_opt : 'a t opt -> (event_jq t -> unit) callback -> jquery t meth
  method blur : jquery t meth
  method change_fun : (event_jq t -> unit) callback -> jquery t meth
  method change_opt : 'a t opt -> (event_jq t -> unit) callback -> jquery t meth
  method change : jquery t meth
  method children : js_string t opt -> jquery t meth
  method clearQueue : js_string t opt -> jquery t meth
  method click_fun : (event_jq t -> unit) callback -> jquery t meth
  method click_opt : 'a t opt -> (event_jq t -> unit) callback -> jquery t meth
  ...
  method contextmenu : (event_jq t -> unit) callback -> jquery t meth
  ...
  method data_get0 : Unsafe.any meth
  method dblclick : jquery t meth
  method dblclick_fun : (event_jq t -> unit) callback -> jquery t meth
  method dblclick_opt : Unsafe.any opt -> (event_jq t -> unit) callback -> jquery t meth
  method delay : int -> js_string t opt -> jquery t meth
  method delegate : js_string t -> js_string t -> (event_jq t -> unit) callback -> jquery t meth
  method delegate_data : js_string t -> js_string t -> Unsafe.any ->
    (event_jq t -> unit) callback -> jquery t meth
  method dequeue : js_string t opt -> jquery t meth
  method detach : js_string t opt -> jquery t meth
  method die : jquery t meth
  method die_type : js_string t -> (js_string t -> unit) callback opt -> jquery t meth
  method each : ( int -> element t -> unit) callback -> jquery t meth
  method empty : jquery t meth
  method _end : jquery t meth
  method eq : int -> jquery t meth
  method error : (event_jq t -> unit) callback -> jquery t meth
  method error_opt : Unsafe.any opt -> (event_jq t -> unit) callback -> jquery t meth
  method fadeIn : int opt -> js_string t opt -> (unit -> unit) callback opt -> jquery t meth
  method fadeIn_json : options t -> jquery t meth
  method fadeOut : int opt -> js_string t opt -> (unit -> unit) callback opt -> jquery t meth
  method fadeOut_json : json t -> jquery t meth
  method fadeTo : int -> int -> js_string t opt -> (unit -> unit) callback opt -> jquery t meth
  method fadeToggle : int opt -> js_string t opt -> (unit -> unit) callback opt -> jquery t meth
  ...
  method focus_fun : (event_jq t -> unit) callback -> jquery t meth
  method focus_opt : Unsafe.any opt -> (event_jq t -> unit) callback -> jquery t meth
  method focus : jquery t meth
  method focusin_fun : (event_jq t -> unit) callback -> jquery t meth
  method focusin_opt : Unsafe.any opt -> (event_jq t -> unit) callback -> jquery t meth
  method focusin : jquery t meth
  method focusout_fun : (event_jq t -> unit) callback -> jquery t meth
  method focusout_opt : Unsafe.any opt -> (event_jq t -> unit) callback -> jquery t meth
  method focusout : jquery t meth
  method get_i : int -> element t meth
  method get : element t meth
  ...
  method hide_opt : int -> js_string t opt -> (unit -> unit) callback opt -> jquery t meth
  method hide_json : options t -> jquery t meth
  method hover_2 : (event_jq t -> unit) callback ->
    (event_jq t -> unit) callback -> jquery t meth
  method hover : (event_jq t -> unit) callback -> jquery t meth
  ...
  method keydown_fun : (event_jq t -> unit) callback -> jquery t meth
  method keydown_opt : Unsafe.any opt -> (event_jq t -> unit) callback -> jquery t meth
  method keydown : jquery t meth
  method keypress_fun : (event_jq t -> unit) callback -> jquery t meth
  method keypress_opt : Unsafe.any opt -> (event_jq t -> unit) callback -> jquery t meth
  method keypress : jquery t meth
  method keyup_fun : (event_jq t -> unit) callback -> jquery t meth
  method keyup_opt : Unsafe.any opt -> (event_jq t -> unit) callback -> jquery t meth
  method keyup : jquery t meth
  method last : jquery t meth
  method length : int prop
  method live : js_string t -> (event_jq t -> unit) callback -> jquery t meth
  method live_json : js_string t -> json t opt -> (event_jq t -> unit) callback -> jquery t meth
  method load_str : js_string t -> js_string t opt ->
    (js_string t -> js_string t -> XmlHttpRequest.xmlHttpRequest -> unit) callback opt
    -> jquery t meth
  method load_fun : (event_jq t-> unit) callback -> jquery t meth
  method load_opt : Unsafe.any opt -> (event_jq t -> unit) callback -> jquery t meth
  method map : (int -> element -> Unsafe.any t) callback -> jquery t meth
  method mousedown : jquery t meth
  method mousedown_fun : (event_jq t -> unit) callback -> jquery t meth
  method mousedown_opt : Unsafe.any opt -> (event_jq t -> unit) callback -> jquery t meth
  method mouseenter : jquery t meth
  method mouseenter_fun : (event_jq t -> unit) callback -> jquery t meth
  method mouseenter_opt : Unsafe.any opt -> (event_jq t -> unit) callback -> jquery t meth
  method mouseleave : jquery t meth
  method mouseleave_fun : (event_jq t -> unit) callback -> jquery t meth
  method mouseleave_opt : Unsafe.any opt -> (event_jq t -> unit) callback -> jquery t meth
  method mousemove : jquery t meth
  method mousemove_fun : (event_jq t -> unit) callback -> jquery t meth
  method mousemove_opt : Unsafe.any opt -> (event_jq t -> unit) callback -> jquery t meth
  method mouseout : jquery t meth
  method mouseout_fun : (event_jq t -> unit) callback -> jquery t meth
  method mouseout_opt : Unsafe.any opt -> (event_jq t -> unit) callback -> jquery t meth
  method mouseover : jquery t meth
  method mouseover_fun : (event_jq t -> unit) callback -> jquery t meth
  method mouseover_opt : Unsafe.any opt -> (event_jq t -> unit) callback -> jquery t meth
  method mouseup : jquery t meth
  method mouseup_fun : (event_jq t -> unit) callback -> jquery t meth
  method mouseup_opt : Unsafe.any opt -> (event_jq t -> unit) callback -> jquery t meth
  ...
  method off_str : js_string t -> js_string t opt -> (event_jq t -> unit) callback opt
    -> jquery t meth
  method off_ev : event_jq t -> jquery t meth
  method off : jquery t meth
  method offset : Unsafe.any t meth
  ...
  method on : js_string t -> js_string t opt -> Unsafe.any opt -> jquery t meth
  method on_fun : js_string t -> js_string t opt -> Unsafe.any opt
    -> (event_jq t -> Unsafe.any opt -> unit) callback -> jquery t meth
  method one : js_string t -> js_string t opt -> Unsafe.any opt -> jquery t meth
  method one_fun : js_string t -> js_string t opt -> Unsafe.any opt
    -> (event_jq t -> unit) callback -> jquery t meth
  ...
  method queue_fun : js_string t opt -> ('a t callback -> unit) callback -> jquery t meth
  method ready : (unit -> unit) callback -> jquery t meth
  ...
  method resize_fun : (event_jq t -> unit) callback -> jquery t meth
  method resize_opt : 'a t opt -> (event_jq t -> unit) callback -> jquery t meth
  method resize : jquery t meth
  method scroll_fun : (event_jq t -> unit) callback -> jquery t meth
  method scroll_opt : 'a t opt -> (event_jq t -> unit) callback -> jquery t meth
  ...
  method select_fun : (event_jq t -> unit) callback -> jquery t meth
  method select_opt : 'a t opt -> (event_jq t -> unit) callback -> jquery t meth
  ...
  method show : int opt -> js_string t opt -> (unit -> unit) callback opt -> jquery t meth
  ...
  method slideDown : int opt -> js_string t opt -> (unit -> unit) callback opt -> jquery t meth
  method slideDown_json : options t -> jquery t meth
  method slideToggle : int opt -> js_string t opt -> (unit -> unit) callback opt -> jquery t meth
  method slideToggle_json : json t -> jquery t meth
  method slideUp : int opt -> js_string t opt -> (unit -> unit) callback opt -> jquery t meth
  ...
  method submit_fun : (event_jq t -> unit) callback -> jquery t meth
  method submit_opt : 'a t opt -> (event_jq t -> unit) callback -> jquery t meth
  ...
  method toggle : int opt -> js_string t opt -> (unit -> unit) callback opt -> jquery t meth
  method toggle_json : options t -> jquery t meth
  method toggle_bool : bool t -> jquery t meth
  method toggle_fun : (event_jq t -> unit) callback -> (event_jq t -> unit) callback
    -> (event_jq t -> unit) callback opt -> jquery t meth
  ...
  method unbind_fun : js_string t -> (event_jq t -> unit) callback opt -> jquery t meth
  ...
  method undelegate_fun : js_string t -> js_string t -> (event_jq t -> unit) callback -> jquery t meth
  method undelegate_json : js_string t -> json t -> jquery t meth
  method undelegate_nm : js_string t -> jquery t meth
  method unload : (event_jq -> unit) callback -> jquery t meth
  method unload_opt : 'a t opt -> (event_jq -> unit) callback -> jquery t meth
...
let add_elt0 e (o:jquery t) = o##add_elt(e)
let add_elt e (o:jquery t) = o##add_elt(To_dom.of_element e)
...
let after_elt0 e (o:jquery t) = o##after_elt(e)
let after_elt e (o:jquery t) = o##after_elt(To_dom.of_element e)
...
let ajax_complete handler (o:jquery t) = o##ajaxComplete(wrap_callback handler)
let ajax_error handler (o:jquery t) =
  o##ajaxError(wrap_callback (fun e xhr json s -> handler e xhr json (to_string s)))
let ajax_send handler (o:jquery t) = o##ajaxSend(wrap_callback handler)
let ajax_start handler (o:jquery t) = o##ajaxStart(wrap_callback handler)
let ajax_stop handler (o:jquery t) = o##ajaxStop(wrap_callback handler)
let ajax_success handler (o:jquery t) = o##ajaxSuccess(wrap_callback handler)
...
let append_elt0 e (o:jquery t) = o##append_elt(e)
let append_elt e (o:jquery t) = o##append_elt(To_dom.of_element e)
...
let append_to_elt0 e (o:jquery t) = o##appendTo_elt(e)
let append_to_elt e (o:jquery t) = o##appendTo_elt(To_dom.of_element e)
let append_to_arr0 a (o:jquery t) = o##appendTo_arr(array a)
let append_to_arr a (o:jquery t) = o##appendTo_arr(array (Array.map To_dom.of_element a))
...
let before_elt0 el (o:jquery t) = o##before_elt(el)
let before_elt el (o:jquery t) = o##before_elt(To_dom.of_element el)
...
let bind_fun ?data typ handler (o:jquery t) =
  o##bind_fun(typ, Opt.option data, wrap_callback handler)
let bind_b ?prevent_bubble ?data typ (o:jquery t) =
  o##bind_b(typ, Opt.option data, Opt.option prevent_bubble)
let blur_fun handler (o:jquery t) = o##blur_fun(wrap_callback handler)
let blur_opt ?data handler (o:jquery t) =
  o##blur_opt(Opt.option data, wrap_callback handler)
let blur (o:jquery t) = o##blur()
let change_fun handler (o:jquery t) = o##change_fun(wrap_callback handler)
let change_opt ?data handler (o:jquery t) =
  o##change_opt(Opt.option data, wrap_callback handler)
...
let click_fun handler (o:jquery t) = o##click_fun(wrap_callback handler)
let click_opt ?data handler (o:jquery t) =
  o##click_opt(Opt.option data, wrap_callback handler)
...
let closest_elt0 e (o:jquery t) = o##closest_elt(e)
let closest_elt e (o:jquery t) = o##closest_elt(To_dom.of_element e)
let closest_jq j (o:jquery t) = o##closest_jq(j)
let contents (o:jquery t) = o##contents()
let context0 (o:jquery t) = o##context
let context (o:jquery t) = Of_dom.of_element o##context
let contextmenu handler (o:jquery t) = o##contextmenu(wrap_callback handler)
...
let dblclick_fun handler (o:jquery t) = o##dblclick_fun(wrap_callback handler)
let dblclick_opt ?data handler (o:jquery t) =
  o##dblclick_opt(Opt.option data, wrap_callback handler)
let delay ?queue d (o:jquery t) = o##delay(d, tropt string queue)
let delegate selector typ handler (o:jquery t) =
  o##delegate(string selector, string typ, wrap_callback handler)
let delegate_data selector typ data handler (o:jquery t) =
  o##delegate_data(string selector, string typ, data, wrap_callback handler)
...
let die_type ?handler typ (o:jquery t) =
  o##die_type(string typ, tropt wrap_callback handler)
let each0 f (o:jquery t) = o##each(wrap_callback f)
let each f (o:jquery t) = o##each(wrap_callback (fun i e -> f i (Of_dom.of_element e)))
...
let filter_fun0 f (o:jquery t) =
  o##filter_fun(wrap_callback (fun i e -> bool (f i e)))
let filter_fun f (o:jquery t) =
  o##filter_fun(wrap_callback (fun i e -> bool (f i (Of_dom.of_element e))))
let filter_elt0 e (o:jquery t) = o##filter_elt(e)
let filter_elt e (o:jquery t) = o##filter_elt(To_dom.of_element e)
let filter_jq j (o:jquery t) = o##filter_jq(j)
let find_str selector (o:jquery t) = o##find_str(string selector)
let find_elt0 e (o:jquery t) = o##find_elt(e)
let find_elt e (o:jquery t) = o##find_elt(To_dom.of_element e)
let find_jq j (o:jquery t) = o##find_jq(j)
let finish ?queue (o:jquery t) = o##finish(tropt string queue)
let first (o:jquery t) = o##first()
let focus_fun handler (o:jquery t) = o##focus_fun(wrap_callback handler)
let focus_opt ?data handler (o:jquery t) =
  o##focus_opt(Opt.option data, wrap_callback handler)
let focus (o:jquery t) = o##focus()
let focusin_fun handler (o:jquery t) = o##focusin_fun(wrap_callback handler)
let focusin_opt ?data handler (o:jquery t) =
  o##focusin_opt(Opt.option data, wrap_callback handler)
let focusin (o:jquery t) = o##focusin()
let focusout_fun handler (o:jquery t) = o##focusout_fun(wrap_callback handler)
let focusout_opt ?data handler (o:jquery t) =
  o##focusout_opt(Opt.option data, wrap_callback handler)
let focusout (o:jquery t) = o##focusout()
let get_i0 i (o:jquery t) = o##get_i(i)
let get_i i (o:jquery t) = Of_dom.of_element o##get_i(i)
let get (o:jquery t) = o##get()
let has_str selector (o:jquery t) = o##has_str(string selector)
let has_elt0 e (o:jquery t) = o##has_elt(e)
let has_elt e (o:jquery t) = o##has_elt(To_dom.of_element e)
...
let hover2 handler_in handler_out (o:jquery t) =
  o##hover_2(wrap_callback handler_in, wrap_callback handler_out)
let hover handler (o:jquery t) = o##hover(wrap_callback handler)
...
let index_elt0 e (o:jquery t) = o##index_elt(e)
let index_elt e (o:jquery t) = o##index_elt(To_dom.of_element e)
...
let insert_after_elt0 e (o:jquery t) = o##insertAfter_elt(e)
let insert_after_elt e (o:jquery t) = o##insertAfter_elt(To_dom.of_element e)
let insert_after_arr0 a (o:jquery t) = o##insertAfter_arr(array a)
let insert_after_arr a (o:jquery t) = o##insertAfter_arr(array (Array.map To_dom.of_element a))
let insert_after_jq j (o:jquery t) = o##insertAfter_jq(j)
let insert_before_str s (o:jquery t) = o##insertBefore_str(string s)
let insert_before_elt0 e (o:jquery t) = o##insertBefore_elt(e)
let insert_before_elt e (o:jquery t) = o##insertBefore_elt(To_dom.of_element e)
let insert_before_arr0 a (o:jquery t) = o##insertBefore_arr(array a)
let insert_before_arr a (o:jquery t) = o##insertBefore_arr(array (Array.map To_dom.of_element a))
let insert_before_jq j (o:jquery t) = o##insertBefore_jq(j)
let is_str selector (o:jquery t) = o##is_str(string selector)
let is_fun0 f (o:jquery t) = o##is_fun(wrap_callback f)
let is_fun f (o:jquery t) = o##is_fun(wrap_callback (fun i e -> f i (Of_dom.of_element e)))
let is_jq j (o:jquery t) = o##is_jq(j)
let is_elt0 e (o:jquery t) = o##is_elt(e)
let is_elt e (o:jquery t) = o##is_elt(To_dom.of_element e)
...
let keydown_opt ?data handler (o:jquery t) =
  o##keydown_opt(Opt.option data, wrap_callback handler)
let keydown (o:jquery t) = o##keydown()
let keypress_fun handler (o:jquery t) = o##keypress_fun(wrap_callback handler)
let keypress_opt ?data handler (o:jquery t) =
  o##keypress_opt(Opt.option data, wrap_callback handler)
let keypress (o:jquery t) = o##keypress()
let keyup_fun handler (o:jquery t) = o##keyup_fun(wrap_callback handler)
let keyup_opt ?data handler (o:jquery t) =
  o##keyup_opt(Opt.option data, wrap_callback handler)
let keyup (o:jquery t) = o##keyup()
let last (o:jquery t) = o##last()
let length (o:jquery t) = o##length
let live events handler (o:jquery t) = o##live(string events, wrap_callback handler)
let live_json ?data events handler (o:jquery t) =
  o##live_json(string events, Opt.option data, wrap_callback handler)
...
let load_opt ?data handler (o:jquery t) =
  o##load_opt(Opt.option data, wrap_callback handler)
let map0 callback (o:jquery t) = o##map(wrap_callback callback)
(* let map callback (o:jquery t) =
 *   o##map(wrap_callback (fun i e -> callback i (Of_dom.of_element e))) *)
let mousedown (o:jquery t) = o##mousedown()
let mousedown_fun handler (o:jquery t) = o##mousedown_fun(wrap_callback handler)
let mousedown_opt ?data handler (o:jquery t) =
  o##mousedown_opt(Opt.option data, wrap_callback handler)
let mouseenter (o:jquery t) = o##mouseenter()
let mouseenter_fun handler (o:jquery t) = o##mouseenter_fun(wrap_callback handler)
let mouseenter_opt ?data handler (o:jquery t) =
  o##mouseenter_opt(Opt.option data, wrap_callback handler)
let mouseleave (o:jquery t) = o##mouseleave()
let mouseleave_fun handler (o:jquery t) = o##mouseleave_fun(wrap_callback handler)
let mouseleave_opt ?data handler (o:jquery t) =
  o##mouseleave_opt(Opt.option data, wrap_callback handler)
let mousemove (o:jquery t) = o##mousemove()
let mousemove_fun handler (o:jquery t) = o##mousemove_fun(wrap_callback handler)
let mousemove_opt ?data handler (o:jquery t) =
  o##mousemove_opt(Opt.option data, wrap_callback handler)
let mouseout (o:jquery t) = o##mouseout()
let mouseout_fun handler (o:jquery t) = o##mouseout_fun(wrap_callback handler)
let mouseout_opt ?data handler (o:jquery t) =
  o##mouseout_opt(Opt.option data, wrap_callback handler)
let mouseover (o:jquery t) = o##mouseover()
let mouseover_fun handler (o:jquery t) = o##mouseover_fun(wrap_callback handler)
let mouseover_opt ?data handler (o:jquery t) =
  o##mouseover_opt(Opt.option data, wrap_callback handler)
let mouseup (o:jquery t) = o##mouseup()
let mouseup_fun handler (o:jquery t) = o##mouseup_fun(wrap_callback handler)
let mouseup_opt ?data handler (o:jquery t) =
  o##mouseup_opt(Opt.option data, wrap_callback handler)
...
let next_until_elt0 ?element ?filter (o:jquery t) =
  o##nextUntil_elt(Opt.option element, tropt string filter)
let next_until_elt ?element ?filter (o:jquery t) =
  o##nextUntil_elt(tropt To_dom.of_element element, tropt string filter)
...
let not_elt0 e (o:jquery t) = o##not_elt(e)
let not_elt e (o:jquery t) = o##not_elt(To_dom.of_element e)
let not_arr0 a (o:jquery t) = o##not_arr(array a)
let not_arr a (o:jquery t) = o##not_arr(array (Array.map To_dom.of_element a))
let not_jq j (o:jquery t) = o##not_jq(j)
let off_str ?selector ?handler events (o:jquery t) =
  o##off_str(string events, tropt string selector, tropt wrap_callback handler)
...
let on_fun ?selector ?data events handler (o:jquery t) =
  o##on_fun(string events, tropt string selector, Opt.option data, wrap_callback handler)
...
let one_fun ?selector ?data events handler (o:jquery t) =
  o##one_fun(string events, tropt string selector, Opt.option data, wrap_callback handler)
...
let parents_until_elt0 ?element ?filter (o:jquery t) =
  o##parentsUntil_elt(Opt.option element, tropt string filter)
let parents_until_elt ?element ?filter (o:jquery t) =
  o##parentsUntil_elt(tropt To_dom.of_element element, tropt string filter)
...
let prepend_elt0 content (o:jquery t) = o##prepend_elt(content)
let prepend_elt content (o:jquery t) = o##prepend_elt(To_dom.of_element content)
let prepend_jq content (o:jquery t) = o##prepend_jq(content)
let prepend_arr0 content (o:jquery t) = o##prepend_arr(array content)
let prepend_arr content (o:jquery t) = o##prepend_arr(array (Array.map To_dom.of_element content))
...
let prepend_to_elt0 content (o:jquery t) = o##prependTo_elt(content)
let prepend_to_elt content (o:jquery t) = o##prependTo_elt(To_dom.of_element content)
let prepend_to_jq content (o:jquery t) = o##prependTo_jq(content)
let prepend_to_arr0 content (o:jquery t) = o##prependTo_arr(array content)
let prepend_to_arr content (o:jquery t) = o##prependTo_arr(array (Array.map To_dom.of_element content))
...
let prev_until_elt0 ?element ?filter (o:jquery t) =
  o##prevUntil_elt(Opt.option element, tropt string filter)
let prev_until_elt ?element ?filter (o:jquery t) =
  o##prevUntil_elt(tropt To_dom.of_element element, tropt string filter)
...
let push_stack0 a (o:jquery t) = o##pushStack(array a)
let push_stack a (o:jquery t) = o##pushStack(array (Array.map To_dom.of_element a))
let push_stack_str0 a name arguments (o:jquery t) =
  o##pushStack_str(array a, string name, array (Array.map string arguments))
let push_stack_str a name arguments (o:jquery t) =
  o##pushStack_str(array (Array.map To_dom.of_element a),
                   string name, array (Array.map string arguments))
...
let replace_all_elt0 e (o:jquery t) = o##replaceAll_elt(e)
let replace_all_elt e (o:jquery t) = o##replaceAll_elt(To_dom.of_element e)
let replace_all_arr0 a (o:jquery t) = o##replaceAll_arr(array a)
let replace_all_arr a (o:jquery t) = o##replaceAll_arr(array (Array.map To_dom.of_element a))
...
let replace_with_elt0 e (o:jquery t) = o##replaceWith_elt(e)
let replace_with_elt e (o:jquery t) = o##replaceWith_elt(To_dom.of_element e)
let replace_with_arr0 a (o:jquery t) = o##replaceWith_arr(array a)
let replace_with_arr a (o:jquery t) = o##replaceWith_arr(array (Array.map To_dom.of_element a))
let replace_with_fun0 f (o:jquery t) = o##replaceWith_fun(wrap_callback f)
let replace_with_fun f (o:jquery t) =
  o##replaceWith_fun(wrap_callback (fun () -> To_dom.of_element (f ())))
let resize_fun handler (o:jquery t) = o##resize_fun(wrap_callback handler)
let resize_opt ?data handler (o:jquery t) =
  o##resize_opt(Opt.option data, wrap_callback handler)
let resize (o:jquery t) = o##resize()
let scroll_fun handler (o:jquery t) = o##scroll_fun(wrap_callback handler)
let scroll_opt ?data handler (o:jquery t) =
  o##scroll_opt(Opt.option data, wrap_callback handler)
...
let select_fun handler (o:jquery t) = o##select_fun(wrap_callback handler)
let select_opt ?data handler (o:jquery t) =
  o##select_opt(Opt.option data, wrap_callback handler)
...
let submit_fun handler (o:jquery t) = o##submit_fun(wrap_callback handler)
let submit_opt ?data handler (o:jquery t) =
  o##submit_opt(Opt.option data, wrap_callback handler)
...
let toggle_fun ?handler3 handler1 handler2 (o:jquery t) =
  o##toggle_fun(wrap_callback handler1, wrap_callback handler2, tropt wrap_callback handler3)
...
let undelegate_fun selector event_type handler (o:jquery t) =
  o##undelegate_fun(string selector, string event_type, wrap_callback handler)
...
let unload_opt ?data handler (o:jquery t) =
  o##unload_opt(Opt.option data, wrap_callback handler)
...
let wrap_elt0 e (o:jquery t) = o##wrap_elt(e)
let wrap_elt e (o:jquery t) = o##wrap_elt(To_dom.of_element e)
...
let wrap_all_elt0 e (o:jquery t) = o##wrapAll_elt(e)
let wrap_all_elt e (o:jquery t) = o##wrapAll_elt(To_dom.of_element e)
...
let wrap_inner_elt0 e (o:jquery t) = o##wrapInner_elt(e)
let wrap_inner_elt e (o:jquery t) = o##wrapInner_elt(To_dom.of_element e)
