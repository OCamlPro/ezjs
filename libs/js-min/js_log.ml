...
let log_str3 s1 s2 s3 = Firebug.console##log_3 (Js.string s1) (Js.string s2) (Js.string s3)
...
let debug_str3 s1 s2 s3 = Firebug.console##debug_3 (Js.string s1) (Js.string s2) (Js.string s3)
...
let warn_str3 s1 s2 s3 = Firebug.console##warn_3 (Js.string s1) (Js.string s2) (Js.string s3)
...
let error_str3 s1 s2 s3 = Firebug.console##error_3 (Js.string s1) (Js.string s2) (Js.string s3)
