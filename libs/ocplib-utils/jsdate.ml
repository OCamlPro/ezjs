...
(* Date constructor *)
let date_now () = new%js date_now
let date_fromTimeValue t = new%js date_fromTimeValue t
let date_month y m = new%js date_month y m
let date_day y m d = new%js date_day y m d
let date_hour y m d h = new%js date_hour y m d h
let date_min y m d h mi = new%js date_min y m d h mi
let date_sec y m d h mi s = new%js date_sec y m d h mi s
let date_ms y m d h mi s ms = new%js date_ms y m d h mi s ms
